      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Accédez à une collection sélectionnée d&apos;indicateurs et de
            stratégies professionnelles pour TradingView. Inscrivez-vous avec
            votre e-mail uniquement&nbsp;: aucun mot de passe requis&nbsp;!
          </p>
          <div className="mt-8">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <Card className="p-6">
            ...
            <p className="text-muted-foreground">
              Accédez à des indicateurs et stratégies Pine Script créés par des
              professionnels.
            </p>
          </Card>
          ...
          <Card className="p-6">
            ...
            <h2 className="text-xl font-semibold mb-2">Connexion sécurisée</h2>
            <p className="text-muted-foreground">
              Connexion simple et sécurisée avec votre e-mail uniquement. Aucun
